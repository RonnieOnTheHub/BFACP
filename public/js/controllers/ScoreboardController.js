angular.module('bfacp').controller('ScoreboardController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$idle', '$modal', 'SBA',
    function ($scope, $rootScope, $http, $timeout, $location, $idle, $modal, SBA) {
        ...
        $scope.admin = {
            ...
            changeMap: function () {
                console.log($scope.map, $scope.gamemode, $scope.roundNum);
                $scope.admin.sendChangeMap($scope.map, $scope.gamemode, $scope.roundNum);
            },
            submit: function () {
                var action = $scope.admin.action;
            ...
            sendChangeMap: function (map, gamemode, roundnum) {
                SBA.map($scope.selectedId, map, gamemode, roundnum).success(function (data) {
                    console.log(data);
                    toastr.error("werkt");
                    $scope.admin.processing = false;
                }).error(function (e) {
